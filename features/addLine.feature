Feature: Colocar un palito
    ...
    Scenario: ver palito del color del jugador actual en el tablero
        ...
        Then deberia ver el palito agregado en "1", "1"
    ...
    Scenario: mostrar la marca si es que se forma un cuadrado
        ...
        When pongo el palito en las coordenadas "1", "1" con la direccion "Horizontal" y es el turno del jugador con el color "azul", hago clic en "Agregar"
        Then deberia ver la marca en la posicion "1.5", "1.5", dentro del cuadrado formado

    Scenario: mantener el turno si es que se forma un cuadrado
        Given estoy en la vista del juego
            And hay tres lineas que pueden formar un cuadrado
        When pongo el palito en las coordenadas "1", "1" con la direccion "Horizontal" y es el turno del jugador con el color "azul" hago clic en "Agregar"
        Then deberia seguir siendo el turno del jugador con el color "azul"
